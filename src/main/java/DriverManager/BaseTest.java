...
// save the screenshot to the path given
    ...
    public static void switchToWindow(String targetTitle) {
        String origin = BaseTest.driver.getWindowHandle();
        for (String handle : BaseTest.driver.getWindowHandles()) {
            BaseTest.driver.switchTo().window(handle);
            if (BaseTest.driver.getTitle().equals(targetTitle)) {
                return;
            }
        }
        BaseTest.driver.switchTo().window(origin);
    }
    //========Hover Over=====//
    ...
    public static List<String> getElementsText(By locator) {
        List<WebElement> elems = BaseTest.driver.findElements(locator);
        List<String> elemTexts = new ArrayList<>();
...
//FluentWait<WebDriver> wait = new FluentWait<WebDriver>(Driver.getDriver()).withTimeout(timeinsec, TimeUnit.SECONDS).pollingEvery(timeinsec, TimeUnit.SECONDS);
        FluentWait<WebDriver> wait = new FluentWait<WebDriver>(BaseTest.driver)
    ...
    public static void doubleClick(WebElement element) {
        new Actions(BaseTest.driver).doubleClick(element).build().perform();
    }
    /**
     * @param element
     * @param check
    ...
    public static void verifyElementDisplayed(By by) {
        try {
            assertTrue("Element not visible: " + by, BaseTest.driver.findElement(by).isDisplayed());
    ...
    public static void verifyElementNotDisplayed(By by) {
        try {
            assertFalse("Element should not be visible: " + by, BaseTest.driver.findElement(by).isDisplayed());
        } catch (NoSuchElementException e) {
            e.printStackTrace();
        }
    }
